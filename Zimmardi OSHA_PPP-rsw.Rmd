...
```
```{r}
PPP2$BizName2 <- PPP2$BusinessName
PPP2
```
...
```{r}
OSHA$BizName2<- str_replace_all(OSHA$BizName2, pattern=fixed('_INC'), replacement=fixed('') )
OSHA$BizName2<- str_replace_all(OSHA$BizName2, pattern=fixed('_LLC'), replacement=fixed('') )
OSHA
```
```{r}
PPP2$BizName2<- str_replace_all(PPP2$BizName2, pattern=fixed('_INC'), replacement=fixed('') )
PPP2$BizName2<- str_replace_all(PPP2$BizName2, pattern=fixed('_LLC'), replacement=fixed('') )
PPP2

```

```{r}
OSHA_PPP <- inner_join(PPP2, OSHA, by=c("BizName2"="BizName2"))
OSHA_PPP
```
